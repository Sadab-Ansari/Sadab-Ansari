...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0077B5,100:00d2ff&height=200&section=header&text=Sadab%20Ansari&fontSize=55&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Full-Stack%20Developer%20%7C%20MERN%20%2B%20AI%20Systems&descAlignY=55&descSize=18" width="100%" />

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=00D2FF&center=true&vCenter=true&width=600&lines=Building+scalable+MERN+%2B+AI+systems;Full-Stack+Developer+%40+MyHealthJourney;Mastering+Distributed+Systems+%26+DSA" />

<p align="center">
  <a href="https://www.linkedin.com/in/sadab-ansari/"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white" /></a>
  <a href="https://leetcode.com/Shadab_112"><img src="https://img.shields.io/badge/LeetCode-FFA116?style=flat&logo=leetcode&logoColor=black" /></a>
  <a href="mailto:sadabansari451@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white" /></a>
</p>
...
### <img src="https://api.iconify.design/mdi/console-line.svg?color=%2300d2ff" width="22" style="vertical-align:middle"/> whoami

```typescript
class SadabAnsari {
  role: string      = "Full-Stack Developer";
  company: string   = "MyHealthJourney Pvt Ltd";
  stack: string[]   = ["MERN", "PERN", "Python / FastAPI"];
  learning: string[] = ["Distributed Systems", "Advanced DSA"];
  focus: string     = "Building scalable MERN + AI systems";

  connect(): string {
    return "sadabansari451@gmail.com";
  }
}

export default new SadabAnsari();
```
...
<table width="100%">
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <img src="https://img.shields.io/badge/AWS-FF9900?style=flat&logoColor=white" />
    </td>
    <td width="50%" valign="top">
      ...
      <img src="https://img.shields.io/badge/VS_Code-007ACC?style=flat&logoColor=white" />
...
### <img src="https://api.iconify.design/mdi/chart-line.svg?color=%2300d2ff" width="22" style="vertical-align:middle"/> Contribution Activity
...
### <img src="https://api.iconify.design/mdi/snake.svg?color=%2300d2ff" width="22" style="vertical-align:middle"/> Contribution Snake
...
* **Scalable MERN Dashboard** — High-performance admin panels with complex data visualization.
* **System Optimization** — Refactored legacy code to improve API response times by ~40%.

<br/>

<div align="center">
  <img src="https://quotes-github-readme.vercel.app/api?type=horizontal&theme=tokyonight&quote=Code%20is%20like%20humor.%20When%20you%20have%20to%20explain%20it%2C%20it%27s%20bad." />
</div>
